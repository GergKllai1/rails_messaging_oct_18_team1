Feature: User can log in and log out
    ...
    Scenario: When I click on login link, I will see login form
        ...
        When I fill in 'Email' field with 'jon@email.com'
        And I fill in 'Password' field with 'password'
        And I tick remember me
        And I click 'Log in'
        Then I should see 'Signed in successfully.'

    Scenario: When I click on logout link, I should get logged out
    ...
    Scenario: When I log in with incorrect email
        Given I am on the login page
        When I fill in 'Email' field with 'jone@email.com'
        And I fill in 'Password' field with 'password'
        And I click 'Log in'
        Then I should see 'Invalid Email or password'